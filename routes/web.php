...
//Route::get('/articles/{magazine}', [HomeController::class, 'articles']);
//Route::get('/episodes/{series}', [HomeController::class, 'episodes']);
...
Route::domain('{locale}.' . $baseDomain)
    ...
    ->group(function () {
		...
		//Route::get('/articles/{magazine}', 'articles');
		//Route::get('/episodes/{series}', 'episodes');
